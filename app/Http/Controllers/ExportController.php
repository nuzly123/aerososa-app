...
class ExportController extends Controller
{
    ...
    {
        // Validar si al menos uno de los campos está presente
        $aircraft_id = $request['aircraft_id'];
        $fecha_inicial = $request['fecha_inicial'];

        if (empty($aircraft_id) && empty($fecha_inicial)) {
            return response()->json(['error' => 'Parámetros de búsqueda insuficientes.'], 422);
        }
