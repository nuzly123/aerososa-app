                ...
                <form action="{{ url('/flight_routes') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-6">
                            ...
                            <select class="custom-select rounded-2" id="origin">
                        ...
                        <div class="col-md-4 mb-6">
                            ...
                            <select class="custom-select rounded-2" id="destination">
                                <option value="0">- Opción -</option>
                                @foreach ($cities as $city)
                                    <option value="{{ $city->id }}">{{ $city->code }}</option>
                                @endforeach
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-12">
                            ...
                            <input type="text" name="route" class="form-control" placeholder="-" required readonly/>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form action="{{ url('/flight_routes') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-6">
                            <label for="nameBasic" class="form-label text-left">Origen</label>
                            <select class="custom-select rounded-2" id="origin" onchange="actualizarRuta()">
                                <option value="0">- Opción -</option>
                                @foreach ($cities as $city)
                                    <option value="{{ $city->id }}">{{ $city->code }}</option>
                                @endforeach
                        ...
                        <div class="col-md-4 mb-6">
                            <label for="nameBasic" class="form-label text-left">Destino</label>
                            <select class="custom-select rounded-2" id="destination" onchange="actualizarRuta()">
                                <option value="0">- Opción -</option>
                                @foreach ($cities as $city)
                                    <option value="{{ $city->id }}">{{ $city->code }}</option>
                                @endforeach
